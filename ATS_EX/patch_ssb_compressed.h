...
const PROGMEM uint8_t cmd_0x15_offsets[] = {
    /* base 0   */ 0, 128,
    /* base 256 */ 148,
    /* base 512 */ 81, 104, 149, 245,
    /* base 768 */ 101, 104, 147, 174, 177, 180, 226, 251, 254,
    /* base 1024*/ 16, 39, 50, 52, 54, 57, 73
};
...
const PROGMEM uint8_t cutoff_places_offsets[] = {
    ...
    /* base 512 */ 137, 244,
    /* base 768 */ 216, 230, 233, 235, 238, 241, 244, 246,
    /* base 1024*/ 44, 59, 63, 66, 68, 74, 77, 79
};

// cutoff payload lengths
// n in [1..99]  -> n data bytes then zeros, next line starts with 0x15 00 00
// n in [100..] -> (n-100) data bytes then zeros, no extra 0x15 line
const PROGMEM uint8_t cutoff_nonzero_lengths[] = {
    /* base 0   */ 102,
    /* base 256 */ 1, 1, 4, 4, 4, 1, 4, 1, 1, 1, 2, 1, 1, 2, 1, 101,
    /* base 512 */ 4, 102,
    /* base 768 */ 3, 3, 1, 4, 1, 1, 1, 4,
    /* base 1024*/ 2, 1, 2, 3, 2, 2, 3, 2
};
